...
const (
	AddressesDataPath = "data/addresses.json"
	ResultAddressDataPath = "data/address_with_coord.json"
...
func ReadJsonFile() ([]Location, error) {
...
func WriteJsonFile(locations []Location) error {
	file, err := json.MarshalIndent(locations, "", "  ")
	if err != nil {
		return fmt.Errorf("Error marshalling json: %v\n", err)
	}

	err = os.WriteFile(ResultAddressDataPath, file, 0644)
	if err != nil {
